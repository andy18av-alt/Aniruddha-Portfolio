      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            <Reveal>
              <Eyebrow num="04">Featured Case Studies</Eyebrow>
            </Reveal>
          ...
          <Reveal delay={0.1} className="lg:col-span-5">
            <p className="text-[14px] leading-relaxed text-neutral-400 max-w-md">
              Selected work at the intersection of product strategy, operational
              systems and practical AI — each shipped, measured and evaluated
        ...
        <div className="mt-16 lg:mt-20 grid lg:grid-cols-12 gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-7 relative p-8 lg:p-12 flex flex-col">
                  ...
                  <div className="mt-8 lg:mt-10">
                    ...
                    <p className="mt-6 text-[15px] lg:text-base leading-[1.75] text-neutral-400 max-w-2xl">
                      An enterprise AI platform that orchestrates explainable
                      investigations, policy interpretation, risk intelligence
                      and human-governed enforcement workflows for large-scale
                      digital platforms.
                    </p>
                  ...
                  <div className="mt-auto pt-10 flex flex-wrap items-center gap-3">
                    ...
                    <a
                      ...
                      aria-label="Explore the TrustOS case study"
                      className="group/btn inline-flex items-center gap-2 h-11 px-6 rounded-full bg-white text-black text-[13px] font-medium shadow-[0_0_0_1px_rgba(255,255,255,0.15)] hover:bg-neutral-100 hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(255,255,255,0.12)] transition-all duration-200"
                    >
                      Explore Case Study
                  ...
                  {featured.buttons.map((b) =>
                    b.kind === 'primary' ? (
                      <a
                        ...
                        target={b.target}
                        rel={b.rel}
                        aria-label={`Explore ${featured.title} case study`}
                        className="group/btn inline-flex items-center gap-2 h-11 px-6 rounded-full bg-white text-black text-[13px] font-medium shadow-[0_0_0_1px_rgba(255,255,255,0.15)] hover:bg-neutral-100 hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(255,255,255,0.12)] transition-all duration-200"
                      >
                        {b.label}
                        <ArrowUpRight className="w-3.5 h-3.5 group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
          ...
          {/* =========================================================
              SIDE STACK — FLIPKART + AI WORKFLOW AUTOMATION
          ========================================================= */}
